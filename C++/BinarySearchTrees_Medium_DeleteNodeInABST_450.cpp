...
class Solution {
    public:
        TreeNode* ReturnLastRight(TreeNode* root)
        {
            if(root -> right == NULL)
            {
                return root;
            }
            return ReturnLastRight(root -> right);
        }
        ...
        TreeNode* helper(TreeNode* root)
        {
            ...
            TreeNode* right_of_Root = root -> right;
            TreeNode* last_right = ReturnLastRight(root -> left);
    
            last_right -> right = right_of_Root;
